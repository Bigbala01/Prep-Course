...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  return array.pop()
  //tambien cuando se desconoce el largo del contenido del array, se utiliza:
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  let pasarAString = n.toString()
if(pasarAString[0] === "9") return true;
return false
}
